{ pkgs, config, ... }: {
  ...
  stylix = {
    ...
    override = {
      # base00= "#e71520"; # Main bg : terminal bg, editor bg, apps main bg
    ...
    image = pkgs.fetchurl {
      url =
        "https://raw.githubusercontent.com/msalmanrafadhlih/Dotfiles/refs/heads/bspwm/home/Assets/Wallpaper/wallpaper8.jpeg";
    ...
    cursor = {
      ...
      package = pkgs.callPackage (pkgs.fetchFromGitHub {
        ...
        repo = "Cursors-memes";
        rev = "main";
        sha256 = "sha256-2WwL4cWwTsPqnZXABMIY0+u46DgkciNb274NzxD9Ty8=";
      }) { };
    };
